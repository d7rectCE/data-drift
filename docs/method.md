...
| KS скользящий (`KSSliding`) | максимум KS по скользящим подокнам | — |
| MeanShift(m) | минимум по последним m окнам разности средней в окне и опорной, в единицах её стандартной ошибки | — |

MeanShift не из river: это простейший тест сдвига среднего ошибки, а при m > 1 — требование
