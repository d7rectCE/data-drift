...
1. **Какую ошибку контролировать:** FDR внутри окна, FDR за весь прогон или частоту ложных тревог
   во времени (эксп. 4, 13).
2. **Хвост калибровки ADWIN** (эксп. 10).
3. **Проверка на продовых логах** и реальные переобучения вместо сбора нового опорного отрезка.
4. **Связанные работы:** сопоставить нулевую гипотезу существенного ухудшения (эксп. 8) с работой
