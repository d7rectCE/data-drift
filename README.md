...
3. **Калибровка хвоста:** поправка на изменчивость оценки нуля (Wu & Apley, двойной
   бутстреп).
4. **Реальные данные:** статистика, требующая устойчивости ухудшения (для всплесков
   Electricity), выбор δ по стоимости переобучения, Airlines и Covertype.
...
experiments/       восемь экспериментов (4–8 — этап 2) и общая обвязка
