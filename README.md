...
1. **Сценарии, где адаптивность FDR может окупиться:** одновременные дрейфы многих
   потоков, неоднородные потоки (разные φ и уровни шума), разная частота дрейфов.
2. **Калибровка хвоста:** поправка на изменчивость оценки нуля (Wu & Apley, двойной
   бутстреп), совместный бутстреп потоков для оценки зависимости.
3. **Процедуры для мониторинга:** BatchBH / BatchSt-BH (Zrnic et al., 2020) для
   пакетной структуры окон, LORD с затухающей памятью, e-детекторы (Dandapanthula &
   Ramdas).
...
6. Циклический дрейф, R-measure, 100 сценариев по плану заявки.
