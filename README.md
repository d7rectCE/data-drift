...
Подробное описание — [docs/method.md](docs/method.md).
...
docs/              описание метода и журнал экспериментов
tests/             70 тестов: совпадение с river, бутстреп, калибровка, процедуры, потоковый режим
