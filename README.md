...
3. **Калибровка хвоста:** поправка на изменчивость оценки нуля (Wu & Apley, двойной
   бутстреп).
4. **Реальные данные:** нулевая гипотеза для сезонных потоков (Electricity), двусторонний
   мониторинг, Airlines и Covertype.
...
experiments/       семь экспериментов (4–7 — этап 2) и общая обвязка
