...
python experiments/exp15_benchmark.py    # бенчмарк всех детекторов при едином FAR
python experiments/exp16_time_buckets.py # Airlines по часам (нужен scikit-learn)
...
src/driftfdr/
  ...
  preprocess.py    усреднение по временным корзинам, выбор допуска δ из стоимости переобучения
  datasets.py      парки моделей на INSECTS, Electricity, Airlines, Covertype
examples/          пример онлайн-мониторинга 50 моделей
experiments/       16 экспериментов (4–16 — этап 2) и общая обвязка
